...
def centroids_from_pages(paths):
    _get_centroids = f.partial(_train_centroids, 20, 41, 40, (1200, 900))
...
def average_clustering(page_dir, img_dir, label_dir, output_dir):
    ...
    label_page = compose(f.partial(new_labelled_page, 20, 41, 40, (1200, 900), trained_centroids), path_formatter)
