...
def centroids_from_pages(paths):
    _get_centroids = f.partial(centroids_from_page_samples, 10000, 61, (0.2,0.2))
...
def average_clustering(page_dir, img_dir, label_dir, output_dir):
    ...
    label_page = compose(f.partial(new_labelled_page, 10000, 61, (0.2,0.2), trained_centroids), path_formatter)
